...
import 'model/StaffshiftNotificationResponce.dart';
...
class _NotificationListState extends State<NotificationList> {
  late Future<StaffshiftNotificationResponce> fetchdata;
  List<NotificationData> shiftoffload = [];
  ...
  Future<void> fetchDataa() async {
    StaffshiftNotificationResponce manufacturerListResponse = await fetchdata;
                    ...
                    padding: EdgeInsets.all(20),
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 5),
                          Text(
                            DateFormat('dd-MMM-yy').format(DateTime.parse(shiftoffload[index].createdAt!)),
                            style: TextStyle(
                              fontFamily: 'Poppins_normal',
                          ...
                          SizedBox(height: 5),
                          Text(shiftoffload[index].subject!,
                          style:  TextStyle(
                              fontFamily: 'Poppins_normal',
                              fontWeight: FontWeight.normal,
                              fontSize: 14,
                     ...
                     new ElevatedButton(
                      onPressed: () {
                        grabstaffoffloadshiftgrab(shiftoffload[index].userId!,shiftoffload[index].id!);
                      },
                      style: ElevatedButton.styleFrom(
                        backgroundColor:  Color(0xFF066E95),
                        shape: RoundedRectangleBorder(
...
class ProcedureApiService {
  ...
  static Future<StaffshiftNotificationResponce> fetchRouteData(
      String userid) async {
    var headers = {'Content-Type': 'application/json'};
    var url =
    Uri.parse(AppUrls.baseUrl + AppUrls.staff_notifications_list);
    Map body = {
      'user_id': userid,
    };
