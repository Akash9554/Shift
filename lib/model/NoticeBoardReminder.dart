...
NoticeBoardReminder routeModelFromJson(String str) => NoticeBoardReminder.fromJson(json.decode(str));

String routeModelToJson(NoticeBoardReminder data) => json.encode(data.toJson());
...
class NoticeBoardReminder {
  ...
  NoticeBoardReminder({this.errorCode, this.errorMsg, this.data});

  NoticeBoardReminder.fromJson(Map<String, dynamic> json) {
